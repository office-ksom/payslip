...
import { onRequestGet as __api_settings_system_js_onRequestGet } from "D:\\KSOM\\Website\\Web Apps\\Payslip\\payslip.git\\payslip-ui\\functions\\api\\settings\\system.js"
import { onRequestPost as __api_settings_system_js_onRequestPost } from "D:\\KSOM\\Website\\Web Apps\\Payslip\\payslip.git\\payslip-ui\\functions\\api\\settings\\system.js"
import { onRequestGet as __api_surrender_cumulative_js_onRequestGet } from "D:\\KSOM\\Website\\Web Apps\\Payslip\\payslip.git\\payslip-ui\\functions\\api\\surrender\\cumulative.js"
...
import { onRequestGet as __api_arrears__month_year__js_onRequestGet } from "D:\\KSOM\\Website\\Web Apps\\Payslip\\payslip.git\\payslip-ui\\functions\\api\\arrears\\[month_year].js"
import { onRequestPost as __api_arrears__month_year__js_onRequestPost } from "D:\\KSOM\\Website\\Web Apps\\Payslip\\payslip.git\\payslip-ui\\functions\\api\\arrears\\[month_year].js"
...
import { onRequestDelete as __api_earnings__month_year__js_onRequestDelete } from "D:\\KSOM\\Website\\Web Apps\\Payslip\\payslip.git\\payslip-ui\\functions\\api\\earnings\\[month_year].js"
...
export const routes = [
    {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_arrears_approve__month_year__js_onRequestGet],
    },
  {
      routePath: "/api/arrears/approve/:month_year",
      mountPath: "/api/arrears/approve",
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_festival_approve__month_year__js_onRequestGet],
    },
  {
      routePath: "/api/festival/approve/:month_year",
      mountPath: "/api/festival/approve",
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_surrender_approve__month_year__js_onRequestGet],
    },
  {
      routePath: "/api/surrender/approve/:month_year",
      mountPath: "/api/surrender/approve",
      method: "POST",
      middlewares: [],
      modules: [__api_surrender_approve__month_year__js_onRequestPost],
    },
  {
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_settings_logs_js_onRequestGet],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_settings_system_js_onRequestGet],
    },
  {
      routePath: "/api/settings/system",
      mountPath: "/api/settings",
      method: "POST",
      middlewares: [],
      modules: [__api_settings_system_js_onRequestPost],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_surrender_cumulative_js_onRequestGet],
    },
  {
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_arrears__month_year__js_onRequestGet],
    },
  {
      routePath: "/api/arrears/:month_year",
      mountPath: "/api/arrears",
      method: "POST",
      middlewares: [],
      modules: [__api_arrears__month_year__js_onRequestPost],
    },
  {
    ...
    },
  {
      ...
      method: "DELETE",
      middlewares: [],
      modules: [__api_earnings__month_year__js_onRequestDelete],
    },
  {
      routePath: "/api/earnings/:month_year",
      mountPath: "/api/earnings",
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_festival__month_year__js_onRequestGet],
    },
  {
      routePath: "/api/festival/:month_year",
      mountPath: "/api/festival",
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_surrender__month_year__js_onRequestGet],
    },
  {
      routePath: "/api/surrender/:month_year",
      mountPath: "/api/surrender",
      method: "POST",
      middlewares: [],
      modules: [__api_surrender__month_year__js_onRequestPost],
    },
  {
